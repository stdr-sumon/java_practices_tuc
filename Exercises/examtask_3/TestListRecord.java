...
public class TestListRecord {
    ...
    public static void main(String[] args) {
        ...
        firstList.add(new Record("Shampoo", 14.5, 4, ProductType.NONFOOD));
        ...
        firstList.printRecords();
        secondList.add(new Record("Apple", 12.5, 4, ProductType.FOOD));
        secondList.add(new Record("Shampoo", 14.5, 4, ProductType.NONFOOD));
        secondList.add(new Record("Gel", 14.5, 4, ProductType.NONFOOD));
        secondList.add(new Record("Rice", 12.5, 4, ProductType.FOOD));
        secondList.add(new Record("Apple", 12.5, 4, ProductType.FOOD));
